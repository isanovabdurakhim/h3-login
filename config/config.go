...
func Load() Config {
	...
	cfg.PostgresUser = cast.ToString(getOrReturnDefaultValue("POSTGRES_USER", "isanov"))
	cfg.PostgresPassword = cast.ToString(getOrReturnDefaultValue("POSTGRES_PASSWORD", "i1saanoff"))
	cfg.PostgresDatabase = cast.ToString(getOrReturnDefaultValue("POSTGRES_DATABASE", "salesdb"))
